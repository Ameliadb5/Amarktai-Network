...
import {
  Cpu, RefreshCw, CheckCircle, AlertCircle, Search,
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-slate-400">
                The primary AI execution layer. All tasks route through the AI Engine by default.
                Direct provider routing is only used as fallback when the AI Engine is unavailable.
              </p>
            </div>
            <button
              onClick={load}
      ...
      <motion.div variants={fadeUp} className="space-y-4">
        ...
        {loading && models.length === 0 ? (
          <div className="flex items-center justify-center py-24">
            ...
            <span className="ml-3 text-sm text-slate-400">Loading AI Engine catalog…</span>
          </div>
        ) : filtered.length === 0 ? (
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-12 text-center">
            ...
            <p className="text-slate-400">
              {models.length === 0
                ? 'No models available. Check AI Engine configuration in Settings.'
      ...
      <motion.div variants={fadeUp}>
        <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-4">
          <p className="text-xs text-slate-500">
            <span className="text-slate-400 font-medium">Fallback providers</span> (OpenAI, Groq, Anthropic, Gemini, etc.) are only used when the AI Engine is unavailable or returns an error.
            Configure them in{' '}
